...
if ( current_user_can( 'edit_theme_options' ) ) {
	...
	$general_entry   = get_theme_mod( 'illdy_latest_news_general_entry', __( 'Check out some of my latest posts, and see more on my blog page!', 'illdy' ) );
				...
				<div class="container">
					<div class="row blog-carousel">
						...
						<?php while ( $post_query->have_posts() ) : ?>
							...
							<?php $post_thumbnail = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'full' ); ?>
