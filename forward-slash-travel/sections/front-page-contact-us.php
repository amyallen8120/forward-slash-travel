...
if ( current_user_can( 'edit_theme_options' ) ) {
	...
	$general_entry          = get_theme_mod( 'illdy_contact_us_entry', __( 'Ask me a question, leave a comment, or just get in touch! I will get back to you as soon as possible.', 'illdy' ) );
